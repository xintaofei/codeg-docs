---
title: 指南
description: 如何使用 Codeg——工作区、内置浏览器、对话聚合与 Token 用量、智能体与多智能体协作、聊天频道、自动化、待办任务，以及 Office、科学研究和项目工作流。
---
...
- [**内置浏览器**](/zh/guide/browser)——网页以标签页的形式开在你的文件旁边：对话和终端里的链接、开发服务器、本地 HTML 的受限视图，以及一个你可以递给对话、或共享给智能体的页面。
- [**无限对话**](/zh/guide/canvas)——把工作区铺在空间里的那块画板：绑定到文件夹的区域、由你亲手整理的合集，以及可以展开成正在进行的对话的固定卡片。
