...
description: The Quick Messages settings screen — build a library of reusable message snippets, order them, and insert them into the composer from the + menu.
---
...
- **Not the same as a skill.** A quick message is plain canned text you insert and can edit before sending; a [skill](/guide/skills) is an executable command an agent runs. Reach for a quick message when you just want to avoid retyping.
